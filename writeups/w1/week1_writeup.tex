...
\[ \mu_{i, a}(s, t+1) = (1 - \eta)\mu_{i, a}(s, t) + \eta \cdot \mu_{i,a}(s, t)^* \]
...
Note, I took $\mu_{\text{min}}$ as uniform across all states to simplify the optimization, although in the report they allow $\mu_{\text{min}}$ to vary across states
which is a possible extension to the above model.

Additionally this could be extended even further to $\mu_{i, p}$, the only difference that instead
